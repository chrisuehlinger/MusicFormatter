...
public class Time implements GuidoConvertable{
	...
	public java.lang.String convertToGuido() {
		java.lang.String convertedText = "\\meter<\"";
		if(symbol != null && symbol != TimeSymbol.NORMAL)
			switch(symbol) {
			case COMMON:
				convertedText = convertedText + "C";
				break;
			case CUT:
				convertedText = convertedText + "C/";
				break;
			...
			convertedText = convertedText + beatsAndBeatType.get(0).getValue() + "/" + beatsAndBeatType.get(1).getValue();
